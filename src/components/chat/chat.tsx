...
const Chat = () => {
  ...
  const {
    ...
    onToolCall: (toolCallEvent) => {
      // If the SDK streams back a tool result, it'll appear here:
      if ('result' in toolCallEvent && toolCallEvent.result !== undefined) {
        addToolResult({
          toolCallId: toolCallEvent.toolCall.toolCallId,
