...
export function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-accent rounded-3xl px-6 py-10 sm:px-12 md:py-14 shadow-xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-16">
          ...
          <motion.div
            ...
            className="relative w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-blue-500 shadow-lg"
          >
            <Image
