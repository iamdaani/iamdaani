...
export default function Contact() {
  ...
  return (
    ...
    >
      {/* Decorative gradient light behind avatar */}
      <div className="absolute -top-20 right-4 h-64 w-64 rounded-full bg-blue-200 opacity-30 blur-3xl pointer-events-none" />
